...
public class CkHomuraMenu {
    ...
    public CkHomuraMenu(Context context) {
        ...
        mExpanded
                .setLayoutParams(new LinearLayout.LayoutParams(dp(MENU_WIDTH), LinearLayout.LayoutParams.WRAP_CONTENT));
        ...
        startimage.setLayoutParams(new RelativeLayout.LayoutParams(RelativeLayout.LayoutParams.WRAP_CONTENT,
                RelativeLayout.LayoutParams.WRAP_CONTENT));
        int applyDimension = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, ICON_SIZE,
        ...
        ((ViewGroup.MarginLayoutParams) startimage.getLayoutParams()).topMargin = (int) ((((float) 10)
        ...
        RelativeLayout.LayoutParams rlsettings = new RelativeLayout.LayoutParams(
        ...
        title.setText(Html.fromHtml("<b>PvZ Touch</b>"));
        ...
        subTitle.setText(Html.fromHtml(
                "<b><marquee><p style=\"font-size:30\"><p style=\"color:green;\">PvZ</p> | PvZ-Mod</p> </marquee></b>"));
        ...
        // ********** Hide/Kill button **********
        RelativeLayout.LayoutParams lParamsHideBtn = new RelativeLayout.LayoutParams(
                RelativeLayout.LayoutParams.WRAP_CONTENT, RelativeLayout.LayoutParams.WRAP_CONTENT);
        ...
        hideBtn.setText("Cerrar");
        hideBtn.setTextColor(TEXT_COLOR);
        hideBtn.setOnClickListener(
                view -> Toast.makeText(getContext, "Mantén presionado para cerrar el menú", Toast.LENGTH_LONG).show());
        hideBtn.setOnLongClickListener(view -> {
            Toast.makeText(getContext, "Menú cerrado", Toast.LENGTH_LONG).show();
        ...
        // ********** Close button **********
        RelativeLayout.LayoutParams lParamsCloseBtn = new RelativeLayout.LayoutParams(
                RelativeLayout.LayoutParams.WRAP_CONTENT, RelativeLayout.LayoutParams.WRAP_CONTENT);
                ...
                switch (motionEvent.getAction()) {
                    ...
                    case MotionEvent.ACTION_UP:
                        ...
                        if (rawX < 10 && rawY < 10 && isViewCollapsed()
                                && System.nanoTime() - initialTime < 500000000) {
                            try {
    ...
    private void featureList(String[] listFT, LinearLayout linearLayout) {
        ...
        for (int i = 0; i < listFT.length; i++) {
            ...
            if (TextUtils.isDigitsOnly(str[0]) || str[0].matches("-\\d*")) {
                ...
                // Subtract feature number. We don't want to count ButtonLink, Category,
                // RichTextView and RichWebView
                featNum = i - subFeat;
            }
    ...
    private void FormationCopy(LinearLayout linLayout, final int featNum, final String featName) {
        ...
        button.setOnClickListener((buttonView) -> {
            ...
            Toast.makeText(getContext, "Formación copiada al portapapeles", Toast.LENGTH_SHORT).show();
            ((ClipboardManager) getContext.getSystemService(Context.CLIPBOARD_SERVICE))
                    .setPrimaryClip(ClipData.newPlainText("c", s));

        });
        linLayout.addView(button);
    }
    // private void SelectValueXY(LinearLayout linearLayout, String featName1, int
    // featNum1, int minValue1, int maxValue1, String featName2, int featNum2, int
    // minValue2, int maxValue2) {
    ...
    // Preferences.changeFeatureInt(featName1, featNum1, numberPicker.getValue()));
    ...
    // Preferences.changeFeatureInt(featName2, featNum2, numberPicker.getValue()));
    //
    ...
    private void SeekBar(LinearLayout linLayout, final int featNum, final String featName, final int min, int max) {
        ...
        seekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int i, boolean z) {
                ...
                textView.setText(
                        Html.fromHtml(featName + ": <font color='" + NumberTxtColor + "'>" + (Math.max(i, min))));
            }
        });
    ...
    private void InputNum(LinearLayout linLayout, final int featNum, final String featName, final int maxValue) {
        ...
        button.setText(Html
                .fromHtml(featName + ": <font color='" + NumberTxtColor + "'>" + ((num == 0) ? 1 : num) + "</font>"));
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.ICE_CREAM_SANDWICH) {
        ...
        button.setOnClickListener(view -> {
            ...
            alertName.setTitle("Ingresar número");
            ...
            alertName.setPositiveButton("Aceptar", (dialog, whichButton) -> {
                int num1;
                try {
                    num1 = Integer.parseInt(
                            TextUtils.isEmpty(editText.getText().toString()) ? "0" : editText.getText().toString());
            ...
            alertName.setNegativeButton("Cancelar", (dialog, whichButton) -> {
    ...
    private void InputText(LinearLayout linLayout, final int featNum, final String featName) {
        ...
        button.setOnClickListener(view -> {
            ...
            alertName.setTitle("Ingresar texto");
            alertName.setView(editText);
            LinearLayout layoutName = new LinearLayout(getContext);
            layoutName.setOrientation(LinearLayout.VERTICAL);
            layoutName.addView(editText); // displays the user input bar
    ...
    private void RadioButton(LinearLayout linLayout, final int featNum, String featName, final String list) {
        ...
        if (index > 0) { // Preventing it to get an index less than 1. below 1 = null = crash
            textView.setText(
                    Html.fromHtml(featName + ": <font color='" + NumberTxtColor + "'>" + lists.get(index - 1)));
    ...
    private void Collapse(LinearLayout linLayout, final String text, final boolean expanded) {
        LinearLayout.LayoutParams layoutParamsLL = new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT,
                LinearLayout.LayoutParams.MATCH_PARENT);
